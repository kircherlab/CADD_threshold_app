...
#### Note:
- The gene panels are retrieved from [Panel App](https://panelapp.genomicsengland.co.uk/). The data is updated regularly, but there might be some delay between the latest PanelApp data and the data used in this tool.
